...
<footer class="page-footer font-small pt-4">
  ...
  <div class="container text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mt-md-0 mt-3">
        ...
        <!-- Content -->
        <h5 class="text-uppercase">Krishi-Online</h5>
        <p>Online Platform for All Agriculture related Products..</p>
  ...
  <div class="footer-copyright text-center py-3">© 2022 Copyright:
    <a href="index.php" style="text-decoration:none; color:#86BBD8;"> Krishi-Online</a>
  </div>
  <!-- Copyright -->
